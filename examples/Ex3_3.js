...
export default class Ex3_3 {
  ...
  initLights() {
    ...
    gl.uniform3fv(uLightDirection, [-0.25, -0.25, -0.25]);
    ...
    gl.uniform4fv(uMaterialDiffuse, [
      46 / 256,
      99 / 256,
      191 / 256,
      1.0
  ...
  change() {
    ...
    gui.add(controls, 'shininess', 0.0, 40.0);
  ...
  update() {
    ...
    const lightAmbient = this.controls.lightAmbient;
    ...
    const materialAmbient = this.controls.materialAmbient;
    gl.uniform4fv(this.uMaterialAmbient, [materialAmbient, materialAmbient, materialAmbient, 1.0]);
    const materialSpecular = this.controls.materialSpecular;
